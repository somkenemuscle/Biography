    ...
    return (
        <div id='education-container'>
            ...
            <p className='education-text'>
                ...
                Einstein recorded that he had "mastered integral and differential calculus" while still just fourteen.His love of algebra and geometry was so great that at twelve, he was already confident that nature could be understood as a "mathematical structure".At thirteen, when his range of enthusiasms had broadened to include music and philosophy,Einstein was introduced to Kant's
                <span tabIndex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="The Critique of Pure Reason (German: Kritik der reinen Vernunft; 1781; second edition 1787) is a book by the German philosopher Immanuel Kant, in which the author seeks to determine the limits and scope of metaphysics.">
                    <span id="popover">Critique of Pure Reason</span>
                </span>
            ...
            <div id='edu2-container'>
                ...
                <p className="education-text">
                    In 1895, at the age of sixteen, Einstein sat the entrance examination for the federal polytechnic school (later the
                    <span tabIndex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="ETH Zurich is a public research university in Zürich, Switzerland. Founded in 1854 with the stated mission to educate engineers and scientists, the university focuses primarily on science, technology, engineering, and mathematics.">
                        <span id="popover">Eidgenössische Technische Hochschule, ETH</span>
                    </span>
            ...
            <div id='edu3-container'>
                ...
                <p className='education-text'>
                    ...
                    As part of the divorce settlement, Einstein agreed that if he were to win a
                    <span tabIndex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="The Nobel Prize in Physics (Swedish: Nobelpriset i fysik) is an annual award given by the Royal Swedish Academy of Sciences for those who have made the most outstanding contributions to mankind in the field of physics. ">
                        <span id="popover">Nobel price</span>
                    </span>
                    , he would give the money that he received to Marić. He won the prize two years later
