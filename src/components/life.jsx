...
export default function Life() {
    ...
    return (
        <div id='life-container'>
            ...
            <p className="life-text">
                In 1880, the family moved to Munich's borough of
                <span tabIndex="0" data-bs-toggle="popover" data-bs-trigger="hover focus" data-bs-content="Ludwigsvorstadt-Isarvorstadt is one of the boroughs of Munich, Germany.">
                    <span id="popover">Ludwigsvorstadt-Isarvorstadt</span>
                </span>
                , where Einstein's father and his uncle Jakob founded Elektrotechnische Fabrik J. Einstein & Cie,
